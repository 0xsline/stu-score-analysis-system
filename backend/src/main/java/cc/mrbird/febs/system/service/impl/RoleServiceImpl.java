...
import cc.mrbird.febs.common.enums.RoleType;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    @Override
    public Role findByTeacher() {
        Wrapper<Role> wrapper = new QueryWrapper<Role>().lambda()
                .eq(Role::getRoleType, RoleType.TEACHER.getCode());
        return baseMapper.selectOne(wrapper);
    }

    @Override
    public Role findByStudent() {
        Wrapper<Role> wrapper = new QueryWrapper<Role>().lambda()
                .eq(Role::getRoleType, RoleType.STUDENT.getCode());
        return baseMapper.selectOne(wrapper);
    }
